...
DB_HOST="ec2-mysqlrds-2iygmt3fhpix.c8igvzbzq8sy.us-east-1.rds.amazonaws.com" # Poner el punto de enlace del RDS
WP_URL="http://borjaticketing.duckdns.org/" # Cambiar a tu dominio
